...
module.exports = {
    listar: async (req, res) => {
        ...
        }).populate('Atividade').populate('Responsavel').sort({ titulo: 1 }); // -1 decrescente 1 crescente
    },
    ...
    excluir: async (req, res) => {
        ...
        (err ? res.status(400).send(err) : res.status(200).json("Andamento deletado com seucesso!"));
        });
    },
